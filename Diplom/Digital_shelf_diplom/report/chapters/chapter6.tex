...
{\gostFont
	...
	\begin{tabular}{p{0,875cm}p{0,3cm}p{15,175cm}}
		& где  & $\textrm{Т}_{\textrm{ст1р}}$ {--} размер базовой ставки, на текущий момент актуальное значение которой 297 бел.руб.; \\
	...
	\formulaspace \par \redline 
		$\textrm{ЗП}_{\textrm{осн}} \textrm{ = 297} \cdot \frac{\textrm{\FTwelwe 1,57}}{\textrm{\FTwelwe 22}} \cdot \textrm{70} \cdot \textrm{1,4 = 2077,11 (бел.руб.)}$ 
	\formulaspace 
	...
	\formulaspace \par \redline 
		$\textrm{ЗП}_{\textrm{доп}} = \textrm{2077,11} \cdot \frac{\textrm{\FTwelwe 15\%}}{\textrm{\FTwelwe 100\%}} \textrm{ = 311,57 (бел.руб.)}$
	\formulaspace
	...
	{\begin{Center} 
		...
		Инженер-   & \multirow{2}{*}{8} & \multirow{2}{*}{1,57} & \multirow{2}{*}{22} & \multirow{2}{*}{1,4} & \multirow{2}{*}{2077,11} & \multirow{2}{*}{311,57} & \multirow{2}{*}{2388,68} \\
		программист& & & & & & & \\ \hline
		Итого   & {--} & {--} & {--} & {--} & 2077,11 & 311,57 & 2388,68 \\ \hline
	\end{tabular} \end{Center}} \addtocounter{tablecntr}{1}
	\botTablespace

	\par \redline Таким образом, как видно из таблицы, заработная плата инженера-программиста составляет 2388,68 бел. руб.
	...
	\formulaspace \par \redline 
		$\textrm{Р}_{\textrm{соц}} = \textrm{(2077,11 + 311,57)} \cdot \frac{\textrm{\FTwelwe 35\%}}{\textrm{\FTwelwe 100\%}} \textrm{ = 836,04 (бел.руб.).}$
	\formulaspace 
	...
	\formulaspace \par \redline 
		$\textrm{Р}_{\textrm{м}} = \textrm{2077,11} \cdot \frac{\textrm{\FTwelwe 4\%}}{\textrm{\FTwelwe 100\%}} \textrm{ = 83,08 (бел.руб.)}$ 
	\formulaspace 
	...
	\formulaspace \par \redline 
		$\textrm{Р}_{\textrm{нр}} = \frac{\textrm{\FTwelwe 75\%}}{\textrm{\FTwelwe 100\%}} \cdot \textrm{2077,11 = 1557,83 (бел.руб.).}$
	\formulaspace
	...
	\formulaspace \par \redline 
		$\textrm{СЗ = 2077,11 + 311,57 + 836,04 + 83,08 + 117,60 + 1557,83 = 4983,23 (бел.руб.).}$
	\formulaspace 
	...
	\formulaspace \par \redline 
		$\textrm{Р}_{\textrm{о}} = \textrm{4983,23} \cdot \frac{\textrm{\FTwelwe 8\%}}{\textrm{\FTwelwe 100\%}} \textrm{ = 398,66 (бел.руб.)}$
    \formulaspace 
	...
	\formulaspace \par \redline 
		$\textrm{Р}_{\textrm{со}} = \textrm{4983,23} \cdot \frac{\textrm{\FTwelwe 7\%}}{\textrm{\FTwelwe 100\%}} \textrm{ = 348,83 (бел.руб.)}$
	\formulaspace 
	...
	\formulaspace \par \redline 
		$\textrm{СП = 4983,23 + 398,66 + 348,83 = 5730,72 (бел.руб.)}$
	\formulaspace 
	...
	\begin{tabular}{|c|c|c|}
		...
		Заработная плата, всего & {--} & 2388,68 \\ \hline
		Основная заработная плата & {--} & 2077,11 \\ \hline
		Дополнительная заработная плата & {--} & 311,57 \\ \hline
		Отчисления на социальные нужды & 35 & 836,04 \\ \hline
		Спецоборудование & Не применялось & {--} \\ \hline
		Материалы и комплектующие изделия & 4 & 83,08 \\ \hline
		Машинное время & {--} & 117,60 \\ \hline
		Научные командировки & Не планировались & {--} \\ \hline
		Прочие затраты & Не применялись & {--} \\ \hline
		Накладные расходы & 75 & 1557,83 \\ \hline
		Сумма затрат & {--} & 4983,23 \\ \hline
		Затраты на освоение & 8 & 398,66 \\ \hline
		Затраты на сопровождение & 7 & 348,83 \\ \hline
		Полная себестоимость & {--} & 5730,72 \\ \hline
	\end{tabular} \end{Center}} \addtocounter{tablecntr}{1} 
	\botTablespace
	
	\par \redline В результате всех расчётов полная себестоимость программного продукта составила 5730,72 бел.руб. 
}
...
{\gostFont
	...
	\formulaspace \par \redline 
		$\textrm{П = 5730,72} \cdot \frac{\textrm{\FTwelwe 23\%}}{\textrm{\FTwelwe 100\%}} \textrm{ = 1318,07 (бел.руб)}$
	\formulaspace
	...
	\formulaspace \par \redline 
		$\textrm{Ц}_{\textrm{п}} = \textrm{5730,72 + 1318,07 = 7048,79 (бел.руб.)}$
	\formulaspace
	...
	\formulaspace \par \redline 
		$\textrm{НДС}_{\textrm{пп}} = \textrm{7048,79} \cdot \frac{\textrm{\FTwelwe 20\%}}{\textrm{\FTwelwe 100\%}} \textrm{ = 1409,76 (бел.руб.)}$
	\formulaspace

	\par \redline Рассчитаем отпускную цену:

	\formulaspace \par \redline 
		$\textrm{Ц}_{\textrm{о}} = \textrm{5730,72 + 1318,07 + 1409,76 = 8458,55 (бел.руб.)}$
	\formulaspace
	...
	\formulaspace \par \redline 
		$\textrm{ПЧ} = \textrm{1318,07} \cdot (\textrm{1} - \frac{\textrm{\FTwelwe 20\%}}{\textrm{\FTwelwe 100\%}}) \textrm{ = 1054,46 (бел.руб.)}$
	\formulaspace
	\subtitlespace
	\subtitlespace
	\subtitlespace
